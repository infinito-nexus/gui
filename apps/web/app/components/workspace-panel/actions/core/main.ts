...
import { createWorkspacePanelEditorActions } from "./editor";
import { createWorkspacePanelSyncActions } from "./sync";
import { createWorkspacePanelWorkspaceActions } from "./workspaces";
